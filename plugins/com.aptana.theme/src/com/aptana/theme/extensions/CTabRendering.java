...
public class CTabRendering extends CTabFolderRenderer implements ICTabRendering
{
	...
	final static int SIDE_DROP_WIDTH = 0;
	final static int BOTTOM_DROP_WIDTH = 4;

	// keylines
	final static int OUTER_KEYLINE = 0;
		...
		switch (part)
		{
			case PART_BODY:
				if (state == SWT.FILL)
				{
					...
					width = 0;// 2 + paddingLeft + paddingRight;
			...
			case PART_BORDER:
				...
				width = 0; // width + 2 * (INNER_KEYLINE + OUTER_KEYLINE + sideDropWidth) + cornerSize / 2;
